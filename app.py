...
def bitly_shorten(url):
    if not url.startswith("https://") and not url.startswith("http://"):
        url = "https://" + url
    try:
        s = pyshorteners.Shortener(api_key='0870d5069f598e333c013809f5e915069852d97d')
...
def cuttly_shorten(url):
    try:
        s = pyshorteners.Shortener(api_key="a1b61b4706a8d51b9e56e4ac90d2eeb96b64d")
...
url_input = gr.Textbox(label="Enter the URL to shorten:",placeholder="https://github.com/itsmebhup")
